...
class CarInterface(CarInterfaceBase):
  ...
  def _update(self, c):
    ...
    for b in ret.buttonEvents:
      ...
      if (b.type in (ButtonType.accelCruise, ButtonType.decelCruise, ButtonType.setCruise) and not b.pressed and self.CP.pcmCruise) or \
      ...
      if (b.type == ButtonType.cancel and b.pressed and not self.CP.pcmCruise) or \
        (not self.CS.pcm_enabled and self.CP.pcmCruise):
